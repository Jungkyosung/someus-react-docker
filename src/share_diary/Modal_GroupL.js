        ...
        <>
            <div className="groupL_modal">
                <div className="groupL_modalImgbox">
                    <img className="groupL_modalImg" src={props.diaryDetailInfo ? `http://${process.env.REACT_APP_REST_API_SERVER_IP}:${process.env.REACT_APP_REST_API_SERVER_PORT}/api/getImage/` + props.diaryDetailInfo.diary_img : ''} />
                </div>
